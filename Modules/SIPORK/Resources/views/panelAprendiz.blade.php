    ...
    <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div class="bg-white rounded-xl p-8 shadow-lg">
            ...
            <p class="text-gray-700 text-lg leading-relaxed mb-4">
                El aprendiz desempeña un papel fundamental en la gestión operativa del sistema SIPORK. Se encarga de ingresar, verificar y actualizar la información relacionada con las actividades de la unidad porcina.
            </p>
