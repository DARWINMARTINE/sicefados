            ...
            <div class="col-md-11 offset-md-0" style="margin-left: 5%;">
                <div class="card shadow-sm">
                    <div class="card-header bg-primary text-white d-flex justify-content-center align-items-center">
                        ...
                        <a href="{{ route('sipork.admin.sipork.insumos_alimenticios.create') }}" class="btn btn-success btn-sm ml-auto" style="transition: all 0.3s ease; color: white;">Añadir Nuevo Suministro</a>
                    </div>
                    <div class="card-body">
                        @if(session('success'))
                        <script>
