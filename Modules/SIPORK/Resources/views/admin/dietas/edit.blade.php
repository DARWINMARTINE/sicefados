            ...
            <div class="col-sm-6">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-light p-2 rounded shadow-sm float-sm-right">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('sipork.admin.sipork.dietas.index') }}" class="text-primary font-weight-bold">
        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="card shadow-lg border-0">
                    ...
                    <form action="{{ route('sipork.admin.sipork.dietas.update', $diet->id_diet) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            @if ($errors->any())
                        ...
                        <div class="card-footer bg-light d-flex justify-content-end">
                            <a href="{{ route('sipork.admin.sipork.dietas.index') }}" class="btn btn-secondary mr-2">
