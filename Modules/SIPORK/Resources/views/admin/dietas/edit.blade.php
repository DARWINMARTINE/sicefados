...
@section('content')
    ...
    <form method="POST" action="{{ route('sipork.admin.sipork.dietas.update', $diet->id_diet) }}">
        @csrf
        @method('PUT')
        ...
        <a href="{{ route('sipork.admin.sipork.dietas.index') }}" class="btn btn-secondary">Cancel</a>
    </form>
@stop
