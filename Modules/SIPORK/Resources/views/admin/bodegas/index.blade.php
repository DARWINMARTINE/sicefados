            ...
            <div class="col-md-11 offset-md-0" style="margin-left: 5%;">
                <div class="card shadow-sm">
                    <div class="card-header bg-primary text-white d-flex justify-content-center align-items-center">
                        ...
                        <a href="{{ route('sipork.admin.sipork.bodegas.create') }}" class="btn btn-success btn-sm ml-auto" style="transition: all 0.3s ease; color: white;">Agregar Nuevo Almacén</a>
                    </div>
                    <div class="card-body">
                        @if(session('success'))
                        <script>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('sipork.admin.sipork.bodegas.show', $warehouse->id_warehouse) }}" class="text-info"
                                            ...
                                            <a href="{{ route('sipork.admin.sipork.bodegas.edit', $warehouse->id_warehouse) }}" class="text-warning"
                                            ...
                                            <form action="{{ route('sipork.admin.sipork.bodegas.destroy', $warehouse->id_warehouse) }}" method="POST" style="display:inline;" onsubmit="return confirmDelete(this);">
                                                @csrf
                                                @method('DELETE')
