...
@section('content')
    ...
    <form method="POST" action="{{ route('sipork.admin.sipork.herramientas.update', $tool->id_tool) }}">
        @csrf
        @method('PUT')
        ...
        <a href="{{ route('sipork.admin.sipork.herramientas.index') }}" class="btn btn-secondary">Cancel</a>
    </form>
@stop
