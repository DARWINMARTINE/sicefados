            ...
            <div class="col-sm-6">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-light p-2 rounded shadow-sm float-sm-right">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('sipork.admin.sipork.ciclos_reproductivos.index') }}" class="text-primary font-weight-bold">
                ...
                <div class="card shadow-lg border-0">
                    ...
                    <form action="{{ route('sipork.admin.sipork.ciclos_reproductivos.update', $reproductiveCycle->id_cycle) }}" method="POST">
                        ...
                        <div class="card-footer bg-light d-flex justify-content-end">
                            <a href="{{ route('sipork.admin.sipork.ciclos_reproductivos.index') }}" class="btn btn-secondary mr-2">
