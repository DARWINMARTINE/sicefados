...
@section('content')
    ...
    <form method="POST" action="{{ route('sipork.admin.sipork.alimentacion.update', $feeding->id_feeding) }}">
        @csrf
        @method('PUT')
        ...
        <a href="{{ route('sipork.admin.sipork.alimentacion.index') }}" class="btn btn-secondary">Cancel</a>
    </form>
@stop
