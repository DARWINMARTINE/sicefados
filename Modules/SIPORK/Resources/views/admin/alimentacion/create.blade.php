...
<br><br><br>
    ...
    <form method="POST" action="{{ route('sipork.admin.sipork.alimentacion.store') }}">
        @csrf
        ...
        <a href="{{ route('sipork.admin.sipork.alimentacion.index') }}" class="btn btn-secondary">Cancelar</a>
    </form>
@stop
