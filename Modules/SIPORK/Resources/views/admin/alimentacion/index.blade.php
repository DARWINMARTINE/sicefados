            ...
            <div class="col-md-11 offset-md-0" style="margin-left: 5%;">
                <div class="card shadow-sm">
                    <div class="card-header bg-primary text-white d-flex justify-content-center align-items-center">
                        ...
                        <a href="{{ route('sipork.admin.sipork.alimentacion.create') }}" class="btn btn-success btn-sm ml-auto" style="transition: all 0.3s ease; color: white;">Add New Feeding Event</a>
                    </div>
                    <div class="card-body">
                        @if (session('success'))
                        <script>
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('sipork.admin.sipork.alimentacion.show', $feeding->id_feeding) }}" class="text-info"
                                            ...
                                            <a href="{{ route('sipork.admin.sipork.alimentacion.edit', $feeding->id_feeding) }}" class="text-warning"
                                            ...
                                            <form action="{{ route('sipork.admin.sipork.alimentacion.destroy', $feeding->id_feeding) }}" method="POST" style="display:inline;" onsubmit="return confirmDelete(this);">
                                                @csrf
                                                @method('DELETE')
