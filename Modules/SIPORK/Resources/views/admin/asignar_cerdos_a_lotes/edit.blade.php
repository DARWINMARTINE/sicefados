...
@section('content')
    ...
    <form method="POST" action="{{ route('sipork.admin.sipork.asignar_cerdos_a_lotes.update', [$pigLot->pig_id, $pigLot->lot_id]) }}">
        @csrf
        @method('PUT')
        ...
        <a href="{{ route('sipork.admin.sipork.asignar_cerdos_a_lotes.index') }}" class="btn btn-secondary">Cancel</a>
    </form>
@stop
