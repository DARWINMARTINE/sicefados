            ...
            <div class="col-md-10 col-lg-8">
                <div class="card form-card animate__animated animate__fadeIn">
                    <div class="card-header">
                        <h3 class="card-title mb-0">Agregar Condición Ambiental</h3>
                    </div>
                    <form method="POST" action="{{ route('sipork.admin.sipork.condiciones_ambientales.store') }}">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <span class="form-icon"><i class="fas fa-wind"></i></span>
                                    @error('ventilation')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="card-footer d-flex justify-content-end">
                            <a href="{{ route('sipork.admin.sipork.condiciones_ambientales.index') }}" class="btn btn-secondary mr-2">Cancelar</a>
...
<script>
    ...
    console.log('Create Environmental Condition Page Loaded');
</script>
@stop