        ...
        <div class="row justify-content-center">
            <div class="col-md-10 col-lg-8">
                <div class="card form-card animate__animated animate__fadeIn">
                    ...
                    <form action="{{ route('sipork.admin.sipork.uso_de_herramientas.store') }}" method="POST">
                        @csrf
                        <div class="card-body">
                            @if ($errors->any())
                        ...
                        <div class="card-footer d-flex justify-content-end">
                            <a href="{{ route('sipork.admin.sipork.uso_de_herramientas.index') }}" class="btn btn-secondary mr-2">Cancelar</a>
