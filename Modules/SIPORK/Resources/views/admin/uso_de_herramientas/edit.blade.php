...
@section('content')
    ...
    <form method="POST" action="{{ route('sipork.admin.sipork.uso_de_herramientas.update', $toolUsage->id_tool_pig) }}
">
        @csrf
        @method('PUT')
        ...
        <a href="{{ route('sipork.admin.sipork.uso_de_herramientas.index') }}" class="btn btn-secondary">Cancel</a>
    </form>
@stop
