            ...
            <div class="col-md-11 offset-md-0" style="margin-left: 5%;"> <!-- Ajuste del margen izquierdo -->
                <div class="card shadow-sm"> <!-- Añadido sombra para mejor diseño -->
                    <div class="card-header bg-primary text-white d-flex justify-content-center align-items-center">
                        ...
                        <a href="{{ route('sipork.admin.sipork.gestion_de_cerdos.create') }}" class="btn btn-success btn-sm ml-auto" style="transition: all 0.3s ease; color: white;">Agregar Nuevo Cerdo</a>
                        <a href="{{ route('sipork.admin.sipork.gestion_de_cerdos.pdf') }}" class="btn btn-danger btn-sm ml-2" target="_blank" style="transition: all 0.3s ease; color: white;">
                            ...
                            <table class="table table-bordered table-hover"> <!-- Aumentar el tamaño horizontal -->
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('sipork.admin.sipork.gestion_de_cerdos.show', $pig->id_pig) }}" class="text-info"
                                            ...
                                            <a href="{{ route('sipork.admin.sipork.gestion_de_cerdos.edit', $pig->id_pig) }}" class="text-warning"
                                            ...
                                            <form action="{{ route('sipork.admin.sipork.gestion_de_cerdos.destroy', $pig->id_pig) }}" method="POST" style="display:inline;" onsubmit="return confirmDelete(this);">
                                                @csrf
                                                @method('DELETE')
