            ...
            <div class="col-sm-6">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-light p-2 rounded shadow-sm float-sm-right">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('sipork.admin.sipork.gestion_de_cerdos.index') }}" class="text-primary font-weight-bold">
        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="card shadow-lg border-0">
                    ...
                    <form action="{{ route('sipork.admin.sipork.gestion_de_cerdos.update', $pig->id_pig) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            <div class="row">
                        ...
                        <div class="card-footer bg-light d-flex justify-content-end">
                            <a href="{{ route('sipork.admin.sipork.gestion_de_cerdos.index') }}" class="btn btn-secondary mr-2">
