...
@section('content')
    ...
    <form method="POST" action="{{ route('sipork.admin.sipork.suministros.update', $supply->id_supply) }}
">
        @csrf
        @method('PUT')
        ...
        <a href="{{ route('sipork.admin.sipork.suministros.index') }}" class="btn btn-secondary">Cancelar</a>
    </form>
@stop
