                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('sipork.liderDeUnidad.sipork.gestion_de_cerdos.create') }}" class="nav-link">
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item has-treeview">
                                    ...
                                    <ul class="nav nav-treeview">
                                        <li class="nav-item">
                                            <a href="{{ route('sipork.liderDeUnidad.sipork.condiciones-ambientales.create') }}" class="nav-link">
                                                <i class="fas fa-plus-circle nav-icon"></i>
                                                <p>Ingreso</p>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="{{ route('sipork.liderDeUnidad.sipork.condiciones-ambientales.index') }}" class="nav-link">
                                                <i class="fas fa-list nav-icon"></i>
                                                <p>Listado</p>
                                            </a>
                                        </li>
                                ...
                                <li class="nav-item has-treeview">
                                    ...
                                    <ul class="nav nav-treeview">
                                        <li class="nav-item">
                                            <a href="{{ route('sipork.liderDeUnidad.sipork.medidas-de-bioseguridad.create') }}" class="nav-link">
                                                <i class="fas fa-plus-circle nav-icon"></i>
                                                <p>Ingreso</p>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="{{ route('sipork.liderDeUnidad.sipork.medidas-de-bioseguridad.index') }}" class="nav-link">
                                                <i class="fas fa-list nav-icon"></i>
                                                <p>Listado</p>
                                            </a>
                                        </li>
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('sipork.liderDeUnidad.sipork.costos-operativos.create') }}"
                                        class="nav-link">
                                        <i class="fas fa-plus-circle nav-icon"></i>
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('sipork.liderDeUnidad.sipork.costos-operativos.index') }}"
                                        class="nav-link">
                                        <i class="fas fa-list nav-icon"></i>
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('sipork.liderDeUnidad.sipork.informes.create') }}"
                                        class="nav-link">
                                        <i class="fas fa-plus-circle nav-icon"></i>
                                        <p>Ingreso</p>
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('sipork.liderDeUnidad.sipork.informes.index') }}"
                                        class="nav-link">
                                        <i class="fas fa-list nav-icon"></i>
                                        <p>Listado</p>
                                    </a>
