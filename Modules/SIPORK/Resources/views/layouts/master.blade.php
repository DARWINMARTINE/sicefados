                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('sipork.admin.sipork.seguimiento_del_crecimiento.create') }}"
                                        class="nav-link">
                                        <i class="fas fa-plus-circle nav-icon"></i>
                                        <p>Ingreso</p>
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('sipork.admin.sipork.seguimiento_del_crecimiento.index') }}"
                                        class="nav-link">
                                        <i class="fas fa-list nav-icon"></i>
                                        <p>Listado</p>
                                    </a>
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('sipork.admin.sipork.registros_de_salud.create') }}"
                                        class="nav-link">
                                        <i class="fas fa-plus-circle nav-icon"></i>
                                        <p>Ingreso</p>
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('sipork.admin.sipork.registros_de_salud.index') }}"
                                        class="nav-link">
                                        <i class="fas fa-list nav-icon"></i>
                                        <p>Listado</p>
                                    </a>
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('sipork.admin.sipork.costos_operativos.create') }}"
                                        class="nav-link">
                                        <i class="fas fa-plus-circle nav-icon"></i>
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('sipork.admin.sipork.costos_operativos.index') }}"
                                        class="nav-link">
                                        <i class="fas fa-list nav-icon"></i>
