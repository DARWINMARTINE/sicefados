...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand" style="background: linear-gradient( #fff2f2, #ffe6e6);">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="{{ route('sipork.aprendiz.panelAprendiz') }}" class="btn btn-success btn-sm ml-2">Volver</a>
            </li>
            <!-- Right navbar links -->
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('sipork.aprendiz.sipork.ALIMENTACION.create') }}"
                                        class="nav-link">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('sipork.aprendiz.sipork.ALIMENTACION.index') }}"
                                        class="nav-link">
