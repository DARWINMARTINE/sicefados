...
<br><br><br>
    ...
    <form method="POST" action="{{ route('sipork.aprendiz.sipork.HERRAMIENTAS.store') }}">
        @csrf
        ...
        <a href="{{ route('sipork.aprendiz.sipork.HERRAMIENTAS.index') }}" class="btn btn-secondary">Cancelar</a>
    </form>
@stop
