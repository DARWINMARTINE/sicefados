            ...
            <div class="col-md-11 offset-md-0" style="margin-left: 5%;">
                <div class="card shadow-sm">
                    <div class="card-header bg-primary text-white d-flex justify-content-center align-items-center">
                        ...
                        <a href="{{ route('sipork.aprendiz.sipork.SUMINISTROS.create') }}" class="btn btn-success btn-sm ml-auto" style="transition: all 0.3s ease; color: white;">Add New Supply</a>
                    </div>
                    <div class="card-body">
                        @if(session('success'))
                        <script>
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('sipork.aprendiz.sipork.SUMINISTROS.show', $supply->id_supply) }}" class="text-info"
                                            ...
                                            <a href="{{ route('sipork.aprendiz.sipork.SUMINISTROS.edit', $supply->id_supply) }}" class="text-warning"
                                            ...
                                            <form action="{{ route('sipork.aprendiz.sipork.SUMINISTROS.destroy', $supply->id_supply) }}" method="POST" style="display:inline;" onsubmit="return confirmDelete(this);">
                                                @csrf
                                                @method('DELETE')
