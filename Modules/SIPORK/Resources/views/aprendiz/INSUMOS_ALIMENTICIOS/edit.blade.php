...
@section('content')
    ...
    <form method="POST" action="{{ route('sipork.aprendiz.sipork.INSUMOS_ALIMENTICIOS.update', $supplyFeeding->id_supply_feeding) }}">
        @csrf
        @method('PUT')
...
@section('js')
    <script> console.log('Edit Supply Feeding Page Loaded'); </script>
@stop