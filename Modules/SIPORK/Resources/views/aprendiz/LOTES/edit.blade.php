...
<br><br><br>
    ...
    <form method="POST" action="{{ route('sipork.aprendiz.sipork.LOTES.update', $lot->id_lot) }}">
        @csrf
        @method('PUT')
        ...
        <a href="{{ route('sipork.aprendiz.sipork.LOTES.index') }}" class="btn btn-secondary">Cancel</a>
    </form>
@stop
