    ...
    <div class="row justify-content-center">
        <div class="col-lg-11">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3 mt-4">
                ...
                <a href="{{ route('sipork.aprendiz.sipork.LOTES.create') }}" class="btn btn-primary shadow-sm">
                ...
                <table class="table table-hover table-bordered rounded shadow-sm bg-white">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                <a href="{{ route('sipork.aprendiz.sipork.LOTES.show', $lot->id_lot) }}" class="text-info"
                                ...
                                <a href="{{ route('sipork.aprendiz.sipork.LOTES.edit', $lot->id_lot) }}" class="text-warning"
                                ...
                                <form action="{{ route('sipork.aprendiz.sipork.LOTES.destroy', $lot->id_lot) }}" method="POST" style="display:inline;" onsubmit="return confirmDelete(this);">
                                    @csrf
                                    @method('DELETE')
