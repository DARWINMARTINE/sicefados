...
<br><br><br>
    ...
    <form method="POST" action="{{ route('sipork.aprendiz.sipork.USO_HERRAMIENTAS.store') }}">
        @csrf
        ...
        <a href="{{ route('sipork.aprendiz.sipork.USO_HERRAMIENTAS.index') }}" class="btn btn-secondary">Cancelar</a>
    </form>
@stop
