...
@section('content')
    ...
    <form method="POST" action="{{ route('sipork.aprendiz.sipork.USO_HERRAMIENTAS.update', $toolUsage->id_tool_pig) }}
">
        @csrf
        @method('PUT')
        ...
        <a href="{{ route('sipork.aprendiz.sipork.USO_HERRAMIENTAS.index') }}" class="btn btn-secondary">Cancel</a>
    </form>
@stop
