    ...
    <div class="row justify-content-center">
        <div class="col-md-12 col-lg-10"> <!-- Aumenta el ancho del contenedor -->
            <div class="card form-card animate__animated animate__fadeIn">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('sipork.aprendiz.sipork.CICLOS_REPRODUCTIVOS.store') }}">
                        @csrf
                        <div class="row">
                            <!-- Sow -->
                        ...
                        <div class="text-center mt-4">
                            ...
                            <a href="{{ route('sipork.aprendiz.sipork.CICLOS_REPRODUCTIVOS.index') }}" class="btn btn-secondary ml-2">Cancelar</a>
                        </div>
                    </form>
                </div>
            </div>
