...
<form method="POST" action="{{ route('sipork.liderDeUnidad.sipork.medidas-de-bioseguridad.store') }}" class="form-horizontal">
    @csrf
    ...
    <a href="{{ route('sipork.liderDeUnidad.sipork.medidas-de-bioseguridad.index') }}" class="btn btn-secondary">Cancelar</a>
</form>
@stop
