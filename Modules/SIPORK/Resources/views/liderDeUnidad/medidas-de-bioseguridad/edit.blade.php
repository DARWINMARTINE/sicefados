...
<form method="POST" action="{{ route('sipork.liderDeUnidad.sipork.medidas-de-bioseguridad.update', $measure->id_biosecurity) }}">
    ...
    <a href="{{ route('sipork.liderDeUnidad.sipork.medidas-de-bioseguridad.index') }}" class="btn btn-secondary">Cancel</a>
</form>
@stop

@section('css')
<link rel="stylesheet" href="/css/liderDeUnidad_custom.css">
@stop
