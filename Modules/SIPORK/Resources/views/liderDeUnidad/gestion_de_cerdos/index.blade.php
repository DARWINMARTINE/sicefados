                            ...
                            <table class="table table-bordered table-hover"> <!-- Aumentar el tamaño horizontal -->
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('sipork.liderDeUnidad.sipork.gestion_de_cerdos.show', $pig->id_pig) }}" class="text-info"
                                            ...
                                            <a href="{{ route('sipork.liderDeUnidad.sipork.gestion_de_cerdos.edit', $pig->id_pig) }}" class="text-warning"
                                            ...
                                            <form action="{{ route('sipork.liderDeUnidad.sipork.gestion_de_cerdos.destroy', $pig->id_pig) }}" method="POST" style="display:inline;" onsubmit="return confirmDelete(this);">
                                                @csrf
                                                @method('DELETE')
