            ...
            <div class="col-md-11">
                <div class="card card-custom animate__animated animate__fadeIn">
                    <div class="card-header card-header-custom">
                        <h3 class="card-title text-center flex-grow-1 mb-0">Condiciones Ambientales</h3>
                        <a href="{{ route('sipork.liderDeUnidad.sipork.condiciones-ambientales.create') }}" class="btn btn-success btn-sm text-white">
                    ...
                    <div class="card-body">
                        ...
                        <div class="alert alert-danger text-center">No hay condiciones registradas aún.</div>
                        @else
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('sipork.liderDeUnidad.sipork.condiciones-ambientales.show', $condition->id_condition) }}" class="text-info mx-1"
                                            ...
                                            <a href="{{ route('sipork.liderDeUnidad.sipork.condiciones-ambientales.edit', $condition->id_condition) }}" class="text-warning mx-1"
                                                style="font-size: 1.5rem; transition: transform 0.3s ease, color 0.3s ease;"
