    ...
    <div class="row justify-content-center">
        <div class="col-12">
            <div class="card form-card animate__animated animate__fadeIn">
                ...
                <div class="card-body">
                    <a href="{{ route('sipork.liderDeUnidad.sipork.costos-operativos.create') }}" class="btn btn-primary mb-4">Create New Cost</a>
                            ...
                            <tbody>
                                ...
                                <tr class="{{ $loop->odd ? 'table-light' : '' }}">
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('sipork.liderDeUnidad.sipork.costos-operativos.show', $operationalCost->id_cost) }}" class="text-info"
                                        ...
                                        <a href="{{ route('sipork.liderDeUnidad.sipork.costos-operativos.edit', $operationalCost->id_cost) }}" class="text-warning"
                                        ...
                                        <form action="{{ route('sipork.liderDeUnidad.sipork.costos-operativos.destroy', $operationalCost->id_cost) }}" method="POST" style="display:inline;" onsubmit="return confirmDelete(this);">
                                            @csrf
                                            @method('DELETE')
