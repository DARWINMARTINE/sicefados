...
<a href="{{ route('sipork.liderDeUnidad.sipork.informes.create') }}" class="btn btn-primary mb-3">Agregar nuevo reporte</a>
...
<table class="table table-bordered">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="{{ route('sipork.liderDeUnidad.sipork.informes.show', $report->id_report) }}" class="text-info"
                ...
                <a href="{{ route('sipork.liderDeUnidad.sipork.informes.edit', $report->id_report) }}" class="text-warning"
